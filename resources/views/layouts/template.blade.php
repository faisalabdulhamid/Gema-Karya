...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{url('dist/components/container.css')}}">
  ...
  <link rel="stylesheet" type="text/css" href="{{url('dist/components/form.css')}}">
  ...
  <link rel="stylesheet" type="text/css" href="{{url('dist/components/message.css')}}">
